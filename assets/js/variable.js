...
var _countdown_date =                   [2016, 08, 1]; // 2016[year] - 12[month] - 24[day]
...
// for mobile
var _bg_style_mobile =                  6; // 1 = image
                                           // 2 = image (mp3 audio)
                                           // 3 = slideshow
                                           // 4 = slideshow (mp3 audio)
                                           // 5 = slideshow (kenburn)
...
var _bg_video_youtube_url =             '59zjsmEABOE'; // youtube video url id - https://www.youtube.com/watch?v=59zjsmEABOE

var _bg_video_youtube_quality =         'hightres'; // hightres, hd1080, hd720, default - youtube video quality
var _bg_video_youtube_start =           90; // seconds - video start time
var _bg_video_youtube_end =             180; // seconds - video end time, 0 to ignored
...
var _bg_effect =                        2; // 0 = disable, 1 = cloud, 2 = star, 3 = parallax star star
